...
# 修改分区大小
#sed -i "s/CONFIG_TARGET_KERNEL_PARTSIZE=128/CONFIG_TARGET_KERNEL_PARTSIZE=128/" .config
sed -i "s/CONFIG_TARGET_ROOTFS_PARTSIZE=300/CONFIG_TARGET_ROOTFS_PARTSIZE=600/" .config
